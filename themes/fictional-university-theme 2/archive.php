<!-- This file is used to render pages that are sub catergories of Authors, Dates, Catergories   -->
...
<div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
        <!-- you could do a loop that checks each archive and customize the h1 header instead -->
